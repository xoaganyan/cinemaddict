const render = (container, text, position = `beforeEnd`) => {
  container.insertAdjacentHTML(position, text);
};

// Header Profile
const getHeaderProfileElement = () => {
  return (
...
// Statistics
const getFooterStatisticsElement = () => {
  return (
...
// rendering elements
render(siteHeaderElement, getHeaderProfileElement());
render(siteMainElement, getMenuElement(), `afterBegin`);
render(siteMainElement, getSortElement());
render(siteMainElement, getContentElement());
render(footerStatisticsElement, getFooterStatisticsElement());
